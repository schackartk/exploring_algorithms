...
Previously, our orthogonal regression line was fine with having a non-zero intercept. This meant that it did not really matter "where" our rescaled data were. However, PCA builds the new axes *through the origin* by definition.

To illustrate the issue with this, we can build an orthogonal regression with the constraint that the intercept be zero.
